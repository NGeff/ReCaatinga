...
const QuizVFGame = ({ game, onComplete, onExit }) => {
  ...
  const handleAnswer = (answer) => {
    ...
    const correctAnswer = questions[currentQuestion].correctAnswer === true || 
    ...
    <div className="game-card">
      ...
      <div className="question-container">
        ...
        <div className="vf-options">
          <button
            className={`vf-button true-button ${
              answered
                ? correctAnswer === true ? 'correct' : selectedAnswer === true ? 'incorrect' : ''
          ...
          >
            ...
            <span className="vf-text">Verdadeiro</span>
          </button>

          <button
            className={`vf-button false-button ${
              answered
                ? correctAnswer === false ? 'correct' : selectedAnswer === false ? 'incorrect' : ''
          ...
          >
            <span className="vf-icon">✕</span>
            <span className="vf-text">Falso</span>
          </button>
        </div>
      </div>
